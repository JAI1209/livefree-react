...
export const FEATURES = [
  {
    ...
    icon: 'Monitor',
    title: 'Workstations',
    desc: 'Ergonomic desks, fast power strips, and a calm productive zone for remote workers and creators.',
  },
  {
    id: 'cafe',
    icon: 'Coffee',
    title: 'In‑House Café',
    desc: 'Start your morning right with freshly brewed chai, espresso, and homestyle bites — steps from your bed.',
  },
  {
    id: 'events',
    icon: 'CalendarHeart',
    title: 'Community Events',
    desc: 'Weekly jam sessions, city walks, bonfire nights, and cultural evenings that bring travelers together.',
  },
  {
    id: 'wifi',
    icon: 'Wifi',
    title: 'High Speed WiFi',
    desc: 'Blazing‑fast fibre internet across every room, lounge, and rooftop — always reliable, always free.',
  },
  {
    id: 'travel',
    icon: 'Backpack',
    title: 'Travel Friendly',
    desc: 'Flexible check‑in windows, secure luggage storage, laundry service, and city‑insider tips on demand.',
  },
  {
    id: 'comfort',
    icon: 'BedDouble',
    title: 'Comfortable Premium Stay',
    desc: 'Hotel‑grade linens, climate control, en‑suite bathrooms, and thoughtful little touches throughout.',
  },
]

export const STATS = [
  { value: 120000, suffix: '+', label: 'Guests Hosted', prefix: '' },
  { value: 8, suffix: '+', label: 'Years of Hospitality', prefix: '' },
...
export const DESTINATIONS = [
  ...
  },
  {
    ...
    desc: 'Colonial charm, pine forests, and the perfect basecamp for mountain escapes.',
    path: '/dehradun',
  ...
  },
  {
    ...
    desc: 'Ancient ghats, evening aartis, and soulful lanes that redefine the meaning of travel.',
    path: '/varanasi',
...
export const AWARDS = [
  {
    ...
    year: '2023',
    property: 'LiveFree Hostel · Rishikesh',
    theme: 'light',
  },
  {
    emoji: '⭐',
  ...
  },
  {
    ...
    platform: 'Booking.com Review Award',
    year: '2023 — 8.7 / 10',
    property: 'LiveFree Hostel · Varanasi',
    theme: 'blue',
  },
  {
    emoji: '🌟',
    ...
    property: 'LiveFree Hostel Network',
    theme: 'dark',
  },
]

export const SOCIAL_IMGS = [
  'https://images.unsplash.com/photo-1541336032412-2048a6785400?w=600&q=80',
  'https://images.unsplash.com/photo-1523239369189-4ed2aefc3a63?w=600&q=80',
  ...
  rishikesh: [
    {
      ...
      activities: [
        'Check-in at LiveFree Hostel',  // TODO: Update activities
