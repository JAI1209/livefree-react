    ...
    <>
      ...
      <div style={styles.hero}>
        <div className="container">
          ...
          <a href="#founders" className="btn btn-primary">Meet Our Team</a>
        </div>
      </div>
          ...
          <div style={styles.foundGrid}>
            {FOUNDERS.map((f, i) => (
              ...
              >
                ...
                {/* <img src={`/assets/${f.name.toLowerCase().replace(' ', '-')}.jpg`} style={{ width: 80, height: 80, borderRadius: '50%', objectFit: 'cover', margin: '0 auto 20px' }} /> */}
