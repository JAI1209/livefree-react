  ...
  return (
    <div style={{ position: 'relative', width: '100%', maxWidth: 380, margin: '0 auto' }}>
      ...
      >
        <path
          fill="#e8856a"
          d="M330,55 Q415,115 420,205 Q425,305 325,345 Q225,385 125,325 Q25,265 20,170 Q15,75 115,38 Q215,0 330,55Z"
        />
        <path
          fill="#f4a07a"
          fillOpacity="0.5"
          d="M290,85 Q360,130 365,215 Q370,305 280,330 Q190,355 110,295 Q30,235 40,155 Q50,75 140,55 Q230,35 290,85Z"
        />
      </svg>

      {/* Cat image clipped to blob shape */}
      <div style={{
        position: 'absolute',
        top: '15%',
        left: '10%',
    ...
    <>
      ...
      <section style={{ padding: '64px 0 80px', background: '#fff' }}>
        <div className="container">
          ...
          {/* Row 1 — blob+cat left, text right */}
          <div style={{
            display: 'grid',
            gridTemplateColumns: '1fr 1fr',
            gap: 56,
            ...
            <motion.div {...fadeUp(0.1)}>
              <BlobWithCat img={CAT_IMG} alt="Cat" toys={['🎾', '🐟']} />
            </motion.div>

            <motion.div {...fadeUp(0.15)}>
              <p style={{ color: 'var(--text-muted)', fontSize: '0.93rem', lineHeight: 1.85 }}>
          ...
          <motion.div {...fadeUp(0.1)} style={{ textAlign: 'center', marginBottom: 72 }}>
            ...
            <a href="/" className="btn btn-primary" style={{ padding: '12px 32px' }}>
              BOOK YOUR STAY →
            </a>
          </motion.div>

          {/* Row 2 — text left, blob+cat right */}
          <div style={{
            display: 'grid',
            gridTemplateColumns: '1fr 1fr',
            gap: 56,
            ...
            <motion.div {...fadeUp(0.15)}>
              <BlobWithCat img={CAT_IMG2} alt="Kitten" flip toys={['🎾', '🐾']} />
            </motion.div>
          </div>
